...
namespace EduSweep_2.Common
{
    public static class FormStatus
    {
        ...
        public static bool QuarantineManagerOpen { get; set; } = false;
        public static bool TaskDesignerOpen { get; set; } = false;
        public static bool ReportManagerOpen { get; set; } = false;
    }
}
